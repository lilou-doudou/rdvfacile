...
var TOKEN_KEY = "rdv_token";
var USER_KEY = "rdv_user";
var AuthService = class _AuthService {
  constructor() {
    ...
    this.businessId = computed(() => this._user()?.businessId ?? "");
  }
  login(payload) {
    return this.http.post(`${environment.apiUrl}/auth/login`, payload).pipe(tap((r) => this.persist(r)));
  }
  register(payload) {
    return this.http.post(`${environment.apiUrl}/auth/register`, payload).pipe(tap((r) => this.persist(r)));
  }
  logout() {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HKVVDLZ3.js.map

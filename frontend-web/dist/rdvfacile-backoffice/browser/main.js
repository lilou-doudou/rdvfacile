...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-4OV6YAZM.js").then((m) => m.LoginComponent),
    canActivate: [guestGuard]
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-L23S2WTU.js").then((m) => m.RegisterComponent),
    canActivate: [guestGuard]
  },
  {
    path: "",
    loadComponent: () => import("./chunk-VLQI3FBF.js").then((m) => m.ShellComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-ZXCX2626.js").then((m) => m.DashboardComponent)
      },
      {
        path: "appointments",
        loadComponent: () => import("./chunk-PKN2ZXZR.js").then((m) => m.AppointmentsComponent)
      },
      {
        path: "services",
        loadComponent: () => import("./chunk-EJQPUAFE.js").then((m) => m.ServicesComponent)
      },
      {
        path: "customers",
        loadComponent: () => import("./chunk-67UCLZR7.js").then((m) => m.CustomersComponent)
      }
    ]
  },

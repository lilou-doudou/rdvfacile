...
var MatSelect = class _MatSelect {
  ...
  _scrollOptionIntoView(index4) {
    const option = this.options.toArray()[index4];
    if (option) {
      const panel = this.panel.nativeElement;
      const labelCount = _countGroupLabelsBeforeOption(index4, this.options, this.optionGroups);
      const element = option._getHostElement();
      if (index4 === 0 && labelCount === 1) {
        panel.scrollTop = 0;
      } else {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _unusedNgZone, defaultErrorStateMatcher, _elementRef, _dir, parentForm, parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, _defaultOptions) {
    ...
    this._openedStream = this.openedChange.pipe(filter((o2) => o2), map(() => {
    }));
    this._closedStream = this.openedChange.pipe(filter((o2) => !o2), map(() => {
    }));
  ...
  _sortValues() {
    if (this.multiple) {
      ...
      this._selectionModel.sort((a3, b3) => {
        return this.sortComparator ? this.sortComparator(a3, b3, options) : options.indexOf(a3) - options.indexOf(b3);
      });
      this.stateChanges.next();
    }
  }
  ...
  _highlightCorrectOption() {
    if (this._keyManager) {
      if (this.empty) {
        ...
        for (let index4 = 0; index4 < this.options.length; index4++) {
          const option = this.options.get(index4);
          if (!option.disabled) {
            firstEnabledOptionIndex = index4;
            break;
          }
        }
...
var MatSelectTrigger = class _MatSelectTrigger {
  static {
    this.\u0275fac = function MatSelectTrigger_Factory(t3) {
      return new (t3 || _MatSelectTrigger)();
    };
  }
  static {
...
var MatSelectModule = class _MatSelectModule {
  static {
    this.\u0275fac = function MatSelectModule_Factory(t3) {
      return new (t3 || _MatSelectModule)();
    };
  }
  static {
...
function A2(n2, l3) {
  if (null == l3)
    return n2.__ ? A2(n2.__, n2.__.__k.indexOf(n2) + 1) : null;
  for (var u3; l3 < n2.__k.length; l3++)
    if (null != (u3 = n2.__k[l3]) && null != u3.__e)
      return u3.__e;
  return "function" == typeof n2.type ? A2(n2) : null;
}
function P(n2) {
  var l3, u3;
...
function $() {
  ...
  for (r.sort(function(n3, l4) {
    ...
    n2.__d && (l3 = r.length, i3 = void 0, t3 = void 0, f3 = (o2 = (u3 = n2).__v).__e, (e3 = u3.__P) && (i3 = [], (t3 = h({}, o2)).__v = o2.__v + 1, M(e3, o2, t3, u3.__n, void 0 !== e3.ownerSVGElement, null != o2.__h ? [f3] : null, i3, null == f3 ? A2(o2) : f3, o2.__h), N(i3, o2), o2.__e != f3 && P(o2)), r.length > l3 && r.sort(function(n3, l4) {
      return n3.__v.__b - l4.__v.__b;
    }));
  $.__r = 0;
}
function H(n2, l3, u3, i3, t3, r3, o2, f3, e3, a3) {
  ...
  for (u3.__k = [], h3 = 0; h3 < l3.length; h3++)
    if (null != (d2 = u3.__k[h3] = null == (d2 = l3[h3]) || "boolean" == typeof d2 ? null : "string" == typeof d2 || "number" == typeof d2 || "bigint" == typeof d2 ? p(null, d2, null, null, d2) : Array.isArray(d2) ? p(_, { children: d2 }, null, null, null) : d2.__b > 0 ? p(d2.type, d2.props, d2.key, d2.ref ? d2.ref : null, d2.__v) : d2)) {
      ...
      M(n2, d2, y3 = y3 || c, t3, r3, o2, f3, e3, a3), k3 = d2.__e, (v3 = d2.ref) && y3.ref != v3 && (g4 || (g4 = []), y3.ref && g4.push(y3.ref, null, d2), g4.push(v3, d2.__c || k3, d2)), null != k3 ? (null == b3 && (b3 = k3), "function" == typeof d2.type && d2.__k === y3.__k ? d2.__d = e3 = I(d2, e3, n2) : e3 = z(n2, d2, y3, m3, k3, e3), "function" == typeof u3.type && (u3.__d = e3)) : e3 && y3.__e == e3 && e3.parentNode != n2 && (e3 = A2(y3));
    }
...
function M(n2, u3, i3, t3, r3, o2, f3, e3, c3) {
  var s3, a3, v3, y3, p3, d2, k3, b3, g4, m3, w4, A4, P3, C3, T4, $3 = u3.type;
...
function O(l3, u3, i3, t3, r3, o2, f3, e3) {
  ...
  if (null === d2)
    ...
    if (k(l3, p3, y3, r3, e3), h3)
      u3.__k = [];
    else if (_3 = u3.props.children, H(l3, Array.isArray(_3) ? _3 : [_3], u3, i3, t3, r3 && "foreignObject" !== d2, o2, f3, o2 ? o2[0] : i3.__k && A2(i3, 0), e3), null != o2)
      for (_3 = o2.length; _3--; )
        null != o2[_3] && v(o2[_3]);
...
function groupIntersectingEntries(entries) {
  ...
  for (let entry of entries) {
    ...
    for (let merge2 of merges) {
      if (intersectSpans(merge2.span, hungryMerge.span)) {
        hungryMerge = {
          entries: merge2.entries.concat(hungryMerge.entries),
          span: joinSpans(merge2.span, hungryMerge.span)
        };
      } else {
        filteredMerges.push(merge2);
      }
    }
...
var AutoScroller = class {
  ...
  queryScrollEls(scrollStartEl) {
    let els = [];
    for (let query2 of this.scrollQuery) {
      if (typeof query2 === "object") {
        els.push(query2);
      } else {
        els.push(...Array.prototype.slice.call(scrollStartEl.getRootNode().querySelectorAll(query2)));
      }
    }
    return els;
  }
...
var _c03 = ["newApptDialog"];
var _c18 = ["detailDialog"];
var _forTrack0 = ($index, $item) => $item.id;
function AppointmentsComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function AppointmentsComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 8);
    \u0275\u0275element(1, "full-calendar", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AppointmentsComponent_ng_template_10_For_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", c_r4.fullName, " \u2014 ", c_r4.phone, "");
  }
}
function AppointmentsComponent_ng_template_10_For_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", s_r5.name, " (", s_r5.durationMinutes, " min)");
  }
}
function AppointmentsComponent_ng_template_10_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 21);
  }
}
function AppointmentsComponent_ng_template_10_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Cr\xE9er ");
  }
}
function AppointmentsComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "h2", 10);
    \u0275\u0275text(1, "Nouveau rendez-vous");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "mat-dialog-content")(3, "form", 11)(4, "mat-form-field", 12)(5, "mat-label");
    \u0275\u0275text(6, "Client");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "mat-select", 13);
    \u0275\u0275repeaterCreate(8, AppointmentsComponent_ng_template_10_For_9_Template, 2, 3, "mat-option", 14, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "mat-form-field", 12)(11, "mat-label");
    \u0275\u0275text(12, "Service");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "mat-select", 15);
    \u0275\u0275repeaterCreate(14, AppointmentsComponent_ng_template_10_For_15_Template, 2, 3, "mat-option", 14, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-form-field", 12)(17, "mat-label");
    \u0275\u0275text(18, "Date et heure de d\xE9but");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "input", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 12)(21, "mat-label");
    \u0275\u0275text(22, "Notes (optionnel)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "textarea", 17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "mat-dialog-actions", 18)(25, "button", 19);
    \u0275\u0275text(26, "Annuler");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "button", 20);
    \u0275\u0275listener("click", function AppointmentsComponent_ng_template_10_Template_button_click_27_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.saveAppointment());
    });
    \u0275\u0275template(28, AppointmentsComponent_ng_template_10_Conditional_28_Template, 1, 0, "mat-spinner", 21)(29, AppointmentsComponent_ng_template_10_Conditional_29_Template, 1, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx_r1.apptForm);
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r1.customers());
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r1.services());
    \u0275\u0275advance(13);
    \u0275\u0275property("disabled", ctx_r1.apptForm.invalid || ctx_r1.saving());
    \u0275\u0275advance();
    \u0275\u0275conditional(28, ctx_r1.saving() ? 28 : 29);
  }
}
function AppointmentsComponent_ng_template_12_Conditional_0_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 24);
    \u0275\u0275listener("click", function AppointmentsComponent_ng_template_12_Conditional_0_Conditional_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.cancelAppointment(ctx_r1.selectedAppt().id));
    });
    \u0275\u0275text(1, " Annuler le RDV ");
    \u0275\u0275elementEnd();
  }
}
function AppointmentsComponent_ng_template_12_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h2", 10);
    \u0275\u0275text(1, "D\xE9tail du rendez-vous");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "mat-dialog-content", 22)(3, "p")(4, "strong");
    \u0275\u0275text(5, "Client :");
    \u0275\u0275elementEnd();
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "mat-dialog-actions", 18)(23, "button", 19);
    \u0275\u0275text(24, "Fermer");
    \u0275\u0275elementEnd();
    \u0275\u0275template(25, AppointmentsComponent_ng_template_12_Conditional_0_Conditional_25_Template, 2, 0, "button", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedAppt().customerName, "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedAppt().serviceName, "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(15, 9, ctx_r1.selectedAppt().startTime, "dd/MM HH:mm"), " \u2192 ", \u0275\u0275pipeBind2(16, 12, ctx_r1.selectedAppt().endTime, "HH:mm"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275classMapInterpolate1("status-badge ", ctx_r1.selectedAppt().status.toLowerCase(), "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.STATUS_LABEL[ctx_r1.selectedAppt().status], " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(25, ctx_r1.selectedAppt().status === "BOOKED" ? 25 : -1);
  }
}
function AppointmentsComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AppointmentsComponent_ng_template_12_Conditional_0_Template, 26, 15);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(0, ctx_r1.selectedAppt() ? 0 : -1);
  }
}
var AppointmentsComponent = class _AppointmentsComponent {
  ...
  ngOnInit() {
    ...
    this.serviceSvc.getAll().subscribe((s3) => this.services.set(s3));
    this.custSvc.getAll().subscribe((c3) => this.customers.set(c3));
  }
  openNewDialog(prefilledStart) {
    if (prefilledStart)
      this.apptForm.patchValue({ startTime: prefilledStart });
  ...
  saveAppointment() {
    ...
    const v3 = this.apptForm.value;
    this.apptSvc.create({
      customerId: v3.customerId,
      serviceId: v3.serviceId,
      startTime: v3.startTime.length === 16 ? v3.startTime + ":00" : v3.startTime,
      notes: v3.notes ?? ""
    }).subscribe({
      next: (appt) => {
        ...
        this.snack.open("Rendez-vous cr\xE9\xE9", "", { duration: 3e3 });
      },
      error: (err) => {
        this.snack.open(err.error?.message ?? "Erreur lors de la cr\xE9ation", "Fermer", { duration: 4e3 });
        this.saving.set(false);
      }
    });
  }
  cancelAppointment(id) {
    this.apptSvc.cancel(id).subscribe({
      next: () => {
        this.appointments.update((list) => list.map((a3) => a3.id === id ? __spreadProps(__spreadValues({}, a3), { status: AppointmentStatus.CANCELLED }) : a3));
        this.refreshCalendarEvents(this.appointments());
        this.dialog.closeAll();
        this.snack.open("Rendez-vous annul\xE9", "", { duration: 3e3 });
      }
    });
  }
  onEventClick(arg) {
    const appt = this.appointments().find((a3) => a3.id === arg.event.id);
    if (appt) {
  ...
  refreshCalendarEvents(appts) {
    this.calendarOptions.events = appts.map((a3) => ({
      id: a3.id,
      title: `${a3.customerName} \u2014 ${a3.serviceName}`,
      start: a3.startTime,
      end: a3.endTime,
      color: a3.status === AppointmentStatus.CANCELLED ? "#c62828" : a3.status === AppointmentStatus.DONE ? "#388e3c" : "#1e7e34",
      textColor: "#fff"
    }));
  }
  ...
  static {
    this.\u0275fac = function AppointmentsComponent_Factory(t3) {
      return new (t3 || _AppointmentsComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppointmentsComponent, selectors: [["app-appointments"]], viewQuery: function AppointmentsComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c03, 5);
        \u0275\u0275viewQuery(_c18, 5);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.newApptDialogRef = _t.first);
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.detailDialogRef = _t.first);
      }
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 1, consts: [["newApptDialog", ""], ["detailDialog", ""], [1, "appointments-page"], [1, "page-header"], [1, "page-title"], ["mat-raised-button", "", "color", "primary", 3, "click"], [1, "loading-center"], ["diameter", "40"], [1, "calendar-card"], [3, "options"], ["mat-dialog-title", ""], [1, "dialog-form", 3, "formGroup"], ["appearance", "outline", 1, "full-width"], ["formControlName", "customerId"], [3, "value"], ["formControlName", "serviceId"], ["matInput", "", "type", "datetime-local", "formControlName", "startTime"], ["matInput", "", "formControlName", "notes", "rows", "2"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "18"], [1, "detail-content"], ["mat-stroked-button", "", "color", "warn"], ["mat-stroked-button", "", "color", "warn", 3, "click"]], template: function AppointmentsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h2", 4);
        \u0275\u0275text(3, "Rendez-vous");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "button", 5);
        \u0275\u0275listener("click", function AppointmentsComponent_Template_button_click_4_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.openNewDialog());
        });
        \u0275\u0275elementStart(5, "mat-icon");
        \u0275\u0275text(6, "add");
        \u0275\u0275elementEnd();
        \u0275\u0275text(7, " Nouveau RDV ");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(8, AppointmentsComponent_Conditional_8_Template, 2, 0, "div", 6)(9, AppointmentsComponent_Conditional_9_Template, 2, 1);
        \u0275\u0275elementEnd();
        \u0275\u0275template(10, AppointmentsComponent_ng_template_10_Template, 30, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(12, AppointmentsComponent_ng_template_12_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
        \u0275\u0275conditional(8, ctx.loading() ? 8 : 9);
      }
    }, dependencies: [DatePipe, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, FullCalendarModule, FullCalendarComponent, MatButtonModule, MatButton, MatIconModule, MatIcon, MatDialogModule, MatDialogClose, MatDialogTitle, MatDialogActions, MatDialogContent, MatFormFieldModule, MatFormField, MatLabel, MatInputModule, MatInput, MatSelectModule, MatSelect, MatOption, MatSnackBarModule, MatProgressSpinnerModule, MatProgressSpinner, MatCardModule, MatCard], styles: ["\n\n.appointments-page[_ngcontent-%COMP%] {\n  height: 100%;\n}\n.page-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 20px;\n}\n.page-title[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 1.5rem;\n  font-weight: 700;\n}\n.loading-center[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  padding: 60px;\n}\n.calendar-card[_ngcontent-%COMP%] {\n  padding: 16px;\n  border-radius: 12px !important;\n}\n.dialog-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  min-width: 340px;\n  padding-top: 8px;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.detail-content[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 8px 0;\n}\nmat-spinner[_ngcontent-%COMP%] {\n  display: inline-block;\n}\n/*# sourceMappingURL=appointments.component.css.map */"] });
  }
};
(() => {
...
//# sourceMappingURL=chunk-PKN2ZXZR.js.map
